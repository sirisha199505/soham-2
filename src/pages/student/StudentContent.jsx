        ...
        <>
          ...
          <div className="flex items-center justify-between gap-3 pb-4">
            <button
              ...
              className="flex items-center gap-2 px-5 py-3 rounded-xl border border-slate-200 background: `linear-gradient(135deg, ${level.color.from}, ${level.color.to})`, text-slate-600 text-sm font-semibold hover:bg-slate-50 disabled:opacity-40 disabled:cursor-not-allowed transition-all"
            >
